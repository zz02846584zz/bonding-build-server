        ...
        return new Promise(async (resolve) => {
            ...
            if (options.ts) {
                ...
                if (!fastRegister) {
                    ...
                    if ((_b = (_a = this.tsconfigJson) === null || _a === void 0 ? void 0 : _a.compilerOptions) === null || _b === void 0 ? void 0 : _b.baseUrl) {
    ...
    async handleClose(isExit, signal) {
        ...
        if (this.child) {
            ...
            if (closeChildRes === childExitError) {
                ...
                try {
                    if (!isWin) {
                        (0, child_process_1.execSync)(`kill -9 ${this.child.pid} || true`);
                    }
