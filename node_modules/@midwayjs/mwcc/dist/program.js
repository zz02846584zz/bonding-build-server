...
class Program {
    constructor(host, files) {
        ...
        const context = (this.context = {
            ...
            getTsOutputPath(filename) {
                ...
                (0, util_1.assert)(files.length === 1);
    ...
    async emit() {
        ...
        const emitResult = this.program.emit(undefined, undefined, undefined, false, {
            before: [
                (0, transformer_1.default)(this.host.compilerHost, this.getTypeChecker(), this.host.getMwccConfig()),
            ],
        });
    ...
    calibrateSourceRoots(host) {
        ...
        this.context.outFiles
            ...
            const json = (0, util_1.safeJsonParse)(content);
