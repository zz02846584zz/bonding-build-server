...
async function compileWithOptions(projectDir, outDir, hintConfig) {
    ...
    const defaultConfig = (0, config_1.getDefaultConfig)(projectDir, outDir);
    const config = (0, config_1.mergeConfigs)(defaultConfig, hintConfig, projectDir);
...
async function compileInProject(projectDir, outDir, hintConfig, overrideConfig) {
    const { config } = (0, config_1.resolveTsConfigFile)(projectDir, outDir, undefined, hintConfig, overrideConfig);
    return compile(projectDir, config);
}
...
const findAndParseTsConfig = function findAndParseTsConfig(projectDir, outDir, configName, hintConfig, overrideConfig) {
    const { config, tsconfigPath } = (0, config_1.resolveTsConfigFile)(projectDir, outDir, configName, hintConfig, overrideConfig);
