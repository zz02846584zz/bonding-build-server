...
function mergeCompilerOptions(base, target, projectDir) {
    var _a;
    const compilerOptions = (0, util_1.extend)(base, target);
    /**
...
function mergeConfigs(base, target, projectDir) {
    ...
    const features = (0, util_1.extend)(base.features, target === null || target === void 0 ? void 0 : target.features);
    return (0, util_1.extend)(base, target, {
        compilerOptions,
        include: [...include],
        features,
    });
...
function resolveTsConfigFile(projectDir, outDir, configName, hintConfig, overrideConfig) {
    ...
    let readConfig;
    if ((tsconfigPath === null || tsconfigPath === void 0 ? void 0 : tsconfigPath.startsWith((0, util_1.toUnix)(projectDir))) === false) {
...
function overrideCompilerOptions(target, compilerOptions, key, val) {
    ...
    (0, util_1.debug)(`override compilerOptions.${key} with ${JSON.stringify(val)}`);
    if (val == null) {
