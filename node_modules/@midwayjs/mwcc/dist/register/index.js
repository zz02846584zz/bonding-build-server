...
const createProgram = () => {
    ...
    (0, util_1.debug)('cwd', cwd);
    const { config } = (0, config_1.resolveTsConfigFile)(cwd, undefined, undefined, undefined, {
        compilerOptions: {
            sourceMap: true,
