...
const getExpressionBaseInfo = expression => {
    ...
    const code = (0, util_1.getSourceFileText)(expression);
    let params = [];
    if ((_a = expression.arguments) === null || _a === void 0 ? void 0 : _a.length) {
        params = (0, params_1.formatParams)(expression.arguments);
    }
    ...
    return {
        ...
        position: {
            ...
            start: (0, util_1.getCodePositionInfo)(code, expression.pos),
            end: (0, util_1.getCodePositionInfo)(code, expression.end),
        },
    };
};
