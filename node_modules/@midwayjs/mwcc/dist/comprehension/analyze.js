...
class Analyzer {
    constructor(options) {
        ...
        this.projectDir = (0, util_1.toUnix)(this.program.context.projectDir);
    ...
    getClasses() {
        ...
        for (const sourceFile of this.program.getSourceFiles()) {
            const classes = (0, tsquery_1.query)(sourceFile, 'ClassDeclaration');
    ...
    getDecorators() {
        ...
        const decoratorList = [];
        for (const sourceFile of this.program.getSourceFiles()) {
            const decorators = (0, tsquery_1.query)(sourceFile, 'ClassDeclaration Decorator');
    ...
    getClassInfo(classItem) {
        ...
        return (0, node_1.getClassInfo)(classItem);
    }
    analyzeDecorator(decorator) {
        ...
        const expressionInfo = (0, expression_1.getExpressionBaseInfo)(decorator.expression);
        if (!expressionInfo) {
            return;
        }
        ...
        const decoratorInfo = {
            ...
            target: (0, node_1.getNodeInfo)(decorator.parent, this.analyzeResult.class),
        };
