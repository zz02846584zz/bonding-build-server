...
function parseConfigurationInJS(sourceFile, program) {
    const decorations = (0, tsquery_1.query)(sourceFile, 'CallExpression[expression.escapedText="___decorate"]');
    const result = {
        imports: [],
        configs: [],
    };
...
function resolveDecoratorCallExpression(expression, program) {
    ...
    if (typescript_1.default.isIdentifier(expression.expression)) {
        ...
        if ((0, util_1.any)((0, module_1.resolveImportedName)(symbol), isMidwayJsConfigurationDecorator)) {
    ...
    if (typescript_1.default.isPropertyAccessExpression(expression.expression)) {
        ...
        if ((0, util_1.any)((0, module_1.resolveImportedName)(symbol), mod => isMidwayJsConfigurationDecorator(mod, expr.name.escapedText))) {
            const config = resolveConfiguration(arg);
            return config;
        }
    }
