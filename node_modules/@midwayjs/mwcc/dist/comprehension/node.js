...
const getNodeInfo = (node, classInfo) => {
    ...
    if (typescript_1.default.isMethodDeclaration(node)) {
        ...
        const name = ((_a = node === null || node === void 0 ? void 0 : node.name) === null || _a === void 0 ? void 0 : _a.escapedText) || '';
        const memberInfo = (_c = (_b = classDetail === null || classDetail === void 0 ? void 0 : classDetail.nodeInfo) === null || _b === void 0 ? void 0 : _b.member) === null || _c === void 0 ? void 0 : _c[name];
        if (memberInfo) {
            return memberInfo;
        }
    }
...
const getNodePosition = (node) => {
    const code = (0, util_1.getSourceFileText)(node);
    return {
        range: {
            start: node.pos,
            end: node.end,
        },
        start: (0, util_1.getCodePositionInfo)(code, node.pos),
        end: (0, util_1.getCodePositionInfo)(code, node.end),
    };
};
const getBaseInfo = (node) => {
    var _a;
    let { fileName } = node.getSourceFile();
    fileName = (0, util_1.toUnix)(fileName);
    let name = ((_a = node === null || node === void 0 ? void 0 : node.name) === null || _a === void 0 ? void 0 : _a.escapedText) || '';
...
const getClassInfo = (classItem) => {
    ...
    const classInfo = {
        exportType: (0, exports.getExportType)(classItem),
        member: {},
    };
    ...
    classItem.members.forEach(member => {
        ...
        if (memberInfo.type === 'method') {
            const parameters = member === null || member === void 0 ? void 0 : member.parameters;
            const params = parameters ? (0, params_1.formatParams)(parameters) : [];
