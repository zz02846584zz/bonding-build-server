...
class TnvmAgent {
    ...
    findBash() {
        let { value: path } = (0, util_1.tryCatch)(() => childProcess.execSync('type -p bash', { encoding: 'utf8' }));
        if (path == null) {
            ({ value: path } = (0, util_1.tryCatch)(() => childProcess.execSync('which bash', { encoding: 'utf8' })));
        }
