...
function writeWrapper(options) {
    var _a, _b, _c;
    const { service, distDir, starter, baseDir, cover, faasModName = '@midwayjs/faas', initializeName, advancePreventMultiInit, loadDirectory = [], preloadModules = [], faasStarterName, middleware, clearCache = true, templatePath, moreArgs, preloadFile, moreTemplateVariables = {}, aggregationBeforeExecScript = '', specificStarterName = '', initializeInHandler = false, } = options;
    const files = {};
