...
let CoolUrlTagData = class CoolUrlTagData {
    ...
    async init() {
        const tags = (0, decorator_1.listModule)(tag_1.COOL_URL_TAG_KEY);
        for (const controller of tags) {
            const controllerOption = (0, decorator_1.getClassMetadata)(decorator_1.CONTROLLER_KEY, controller);
            const tagOption = (0, decorator_1.getClassMetadata)(tag_1.COOL_URL_TAG_KEY, controller);
            const data = this.data[tagOption.key] || [];
            this.data[tagOption.key] = data.concat(tagOption.value.map(e => {
...
], CoolUrlTagData.prototype, "init", null);
