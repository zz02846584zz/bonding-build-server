...
let CoolEps = class CoolEps {
    ...
    async entity() {
        const result = {};
        const entitys = (0, decorator_1.listModule)(orm_1.ENTITY_MODEL_KEY);
        for (const entity of entitys) {
            const op = (0, decorator_1.getClassMetadata)(orm_1.ENTITY_MODEL_KEY, entity);
            const commColums = [];
            let columns = (0, typeorm_1.getRepository)(entity, op.connectionName != 'ALL' ? op.connectionName : 'default').metadata.columns;
