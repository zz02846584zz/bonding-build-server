...
let CoolConfiguration = class CoolConfiguration {
    async onReady(container) {
        ...
        // 常用函数处理
        await container.getAsync(data_1.CoolUrlTagData);
        // 事件
        await container.getAsync(index_1.CoolEventManager);
...
__decorate([
    ...
    __metadata("design:type", koa.Framework)
], CoolConfiguration.prototype, "framework", void 0);
__decorate([
    (0, decorator_1.Inject)(),
    __metadata("design:type", index_1.CoolEventManager)
